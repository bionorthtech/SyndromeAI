...
const STORAGE_KEY = 'syndrome-ai-tabs-v2';
const ACTIVE_TAB_KEY = 'syndrome-ai-active-tab-v2';
const PERSISTENCE_ENABLED_KEY = 'syndrome-ai-tab-persistence-enabled';
