...
import syndromeAiLogo from "../../src-tauri/icons/icon.png";
...
function BrandText() {
  return (
    <div className="text-5xl font-extrabold tracking-tight brand-text">
      <span className="brand-text-solid">Syndrome AI</span>
      <span aria-hidden="true" className="brand-text-shimmer">Syndrome AI</span>
    </div>
  );
}
