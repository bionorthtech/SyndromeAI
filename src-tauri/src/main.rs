...
use commands::model_config::{get_model_config, set_model_config, test_local_endpoint};
...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            // Set the Claude directory path synchronously before managing state
            // to avoid a race where checkpoint commands arrive before set_claude_dir completes.
            ...
            {
                tauri::async_runtime::block_on(checkpoint_state.set_claude_dir(claude_dir));
            }
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            get_proxy_settings,
            save_proxy_settings,
            // Model Switcher (cloud / local LM Studio)
            get_model_config,
            set_model_config,
            test_local_endpoint,
        ])
